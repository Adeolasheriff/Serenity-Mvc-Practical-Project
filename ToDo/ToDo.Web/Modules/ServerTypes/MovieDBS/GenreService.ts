...
export namespace GenreService {
    export const baseUrl = 'MovieDBS/Genre';
    ...
    export const Methods = {
        Create: "MovieDBS/Genre/Create",
        Update: "MovieDBS/Genre/Update",
        Delete: "MovieDBS/Genre/Delete",
        Retrieve: "MovieDBS/Genre/Retrieve",
        List: "MovieDBS/Genre/List"
    } as const;
