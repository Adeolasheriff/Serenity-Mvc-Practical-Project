...
export namespace MovieCastService {
    export const baseUrl = 'Administration/MovieCast';
    ...
    export const Methods = {
        Create: "Administration/MovieCast/Create",
        Update: "Administration/MovieCast/Update",
        Delete: "Administration/MovieCast/Delete",
        Retrieve: "Administration/MovieCast/Retrieve",
        List: "Administration/MovieCast/List"
    } as const;
