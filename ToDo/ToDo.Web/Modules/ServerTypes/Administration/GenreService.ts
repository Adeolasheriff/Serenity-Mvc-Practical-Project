...
export namespace GenreService {
    export const baseUrl = 'Administration/Genre';
    ...
    export const Methods = {
        Create: "Administration/Genre/Create",
        Update: "Administration/Genre/Update",
        Delete: "Administration/Genre/Delete",
        Retrieve: "Administration/Genre/Retrieve",
        List: "Administration/Genre/List"
    } as const;
